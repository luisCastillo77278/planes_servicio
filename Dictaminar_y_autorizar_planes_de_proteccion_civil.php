...
<div class="form-group">
    <a type="button" class="btn btn-primary" href="../../index.html">Regresar</a>
	 ...
	 <main class="mt-4 mb-4">
        <div class="container">
            <h1 class="text-center">Dictaminar y Autorizar Planes de Protección Civil</h1>
            <hr>
            <div class="row">
                <div class="col">
              ...
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active " id="denuncia-tab" data-toggle="tab" href="#denuncia" role="tab" aria-controls="denuncia" aria-selected="true ">DATOS NECESARIOS</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="denunciante-tab" data-toggle="tab" href="#denunciante" role="tab" aria-controls="denunciante" aria-selected="false">RECEPCION DE ARCHIVOS</a>
                </li>
                
              </ul>
                        <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active " id="denuncia" role="tabpanel" aria-labelledby="denuncia-tab">
                          <div class="container mt-3 md-6">
                         <div class="form-group">
                     <select  name="tramites" class="browser-default custom-select">
                        <option selected="">Selecciona una Opcion</option>
                        <option value="Plan de contingencia">Plan de contingencia</option>
                        <option value="Planes de respuesta de emergencias">Planes de respuesta de emergencias</option>
                        <option value="Programa de prevencion de accidentes">Programa de prevencion de accidentes</option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <input  type="text" name="Asunto" id="" class="form-control" placeholder="Revisión de plan de contingencia (PLC)"
                                aria-describedby="helpId">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-12">
                              ...
                              <input type="text" name="NombreSol" id="" class="form-control" placeholder="Nombre" aria-describedby="helpId">
                            </div>
                            <div class="form-group col-lg-6 col-md-6">
                                <label for="">Apellido Paterno</label>
                                <input type="text" name="apellidoP" id="" class="form-control" placeholder="Paterno"
                                aria-describedby="helpId">
                            </div>
                            <div class="form-group col-lg-6 col-md-6">
                                <label for="">Apellido Materno</label>
                                <input type="text" name="ApellidoM" id="" class="form-control" placeholder="Materno"
                                aria-describedby="helpId">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-4 col-md-4">
                                <label for="">RFC</label>
                                <input type="text" name="RFC" id="" class="form-control" placeholder="RFC" aria-describedby="helpId">
                            </div>
    
                            <div class="form-group col-lg-4 col-md-4">
                                <label for="">Celular</label>
                                <input type="text" name="Celular" id="" class="form-control" placeholder="9999999999" aria-describedby="helpId">
                            </div>
    
                            <div class="form-group col-lg-4 col-md-4">
                                <label for="">Correo</label>
                                <input type="text" name="correo" id="" class="form-control" placeholder="ejemplo@ejemplo.com" aria-describedby="helpId">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <input type="text" name="DireccionFs" id="" class="form-control" placeholder="Dirección fiscal" aria-describedby="helpId">  
                            </div>
                           
                            <div class="form-group col-lg-6 col-md-6">
                              <label for="">Dirección comercial</label>
                              <input type="text" name="DirecciCom" id="" class="form-control" placeholder="Dirección comercial" aria-describedby="helpId">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-3 col-md-6">
                                ...
                                <input type="text" name="sec" id="" class="form-control" placeholder="Sector" aria-describedby="helpId">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="OficinaCon" id="" class="form-control" placeholder="Oficina con Noº de extensión" aria-describedby="helpId">
                        </div>
                            </div>
                            </div>
                    ...
                    <div class="form-group col-md-6">
                       <label for="ejemplo_archivo_1">Comprobante de domicilio del estado de tabasco</label>
                    <br>
                    ...
                    <div class="form-group col-md-6">
                       <label for="ejemplo_archivo_1">Comprobante de RFC</label>
                    <br>
                    <input type="file" id="ejemplo_archivo_1">
                    <p class="help-block">Documento que valide el RFC</p>
                        ...
                        <div class="d-flex justify-content-end">
                            <input type="submit" value="continuar" class="btn btn-primary btn-block"  style="background-color:#9D2449" >
                        </div>
                        </div>
                            </div>
                        </div>
